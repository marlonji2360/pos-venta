...
\restrict mE0wvJDr7wAWcVXMgS6LCnhVbjMwdbJSRRYYbCGAZoHV18p8yXfYiExbUCYavAj
...
CREATE TABLE public.cuentas_por_pagar (
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT cuentas_por_pagar_estado_check CHECK (((estado)::text = ANY ((ARRAY['pendiente'::character varying, 'parcial'::character varying, 'pagado'::character varying, 'vencido'::character varying])::text[])))
);
...
ALTER TABLE public.cuentas_por_pagar_id_seq OWNER TO marlonjimenez;
...
CREATE TABLE public.notificaciones (
    ...
    CONSTRAINT notificaciones_prioridad_check CHECK (((prioridad)::text = ANY ((ARRAY['baja'::character varying, 'media'::character varying, 'alta'::character varying])::text[])))
);
...
CREATE TABLE public.pagos_proveedores (
    ...
    usuario_id integer,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT pagos_proveedores_metodo_pago_check CHECK (((metodo_pago)::text = ANY ((ARRAY['efectivo'::character varying, 'transferencia'::character varying, 'cheque'::character varying, 'tarjeta'::character varying])::text[])))
);
...
ALTER TABLE public.pagos_proveedores_id_seq OWNER TO marlonjimenez;
...
15	13	7	70	300.00	0.00	21000.00	2025-12-28 20:14:16.201409
16	14	7	2	300.00	0.00	600.00	2025-12-28 20:24:11.140268
\.
...
6	PED-000004	1	3	2025-12-27 21:54:09.445248	2025-12-27 22:00:37.974242	1000.00	recibido		2025-12-27 21:54:09.445248	2025-12-27 21:54:09.445248
\.
...
7	34354354	\N	Coca cola chowi	355 ml	4	200.00	300.00	-9	50	1000	caja	t	30	\N	t	2025-12-24 22:51:28.377696	2025-12-24 22:51:28.377696
\.
...
5	Angel	angel@aguila.com	$2b$10$k8DYj.2kqlyI7QYOd1Qx3.iliP6cYocHXLpbaAlCrjMO/R6dOJL0G	\N	3	t	2025-12-27 22:43:04.963605	2025-12-27 22:42:41.501331	2025-12-27 22:42:41.501331
3	Administrador	admin@tienda.com	$2b$10$gRDs5vywgnB/KtFKgIMhJOy518Yzyhuo9ViBXWvXnFWTH5do2lLHy	\N	1	t	2025-12-28 20:11:54.272235	2025-12-22 16:55:36.955027	2025-12-22 16:55:36.955027
\.
...
13	VTA-000008	\N	3	2025-12-28 20:14:16.201409	21000.00	0.00	0.00	21000.00	efectivo	completada	\N	\N	\N	0.00	\N	2025-12-28 20:14:16.201409	2025-12-28 20:14:16.201409
14	VTA-000009	2	3	2025-12-28 20:24:11.140268	600.00	0.00	0.00	600.00	efectivo	completada	\N	\N	\N	0.00	\N	2025-12-28 20:24:11.140268	2025-12-28 20:24:11.140268
\.
...
SELECT pg_catalog.setval('public.detalle_ventas_id_seq', 16, true);
...
SELECT pg_catalog.setval('public.movimientos_inventario_id_seq', 17, true);
...
SELECT pg_catalog.setval('public.pagos_proveedores_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.pedidos_proveedores_id_seq', 6, true);
...
SELECT pg_catalog.setval('public.ventas_id_seq', 14, true);
...
ALTER TABLE ONLY public.cuentas_por_pagar
    ADD CONSTRAINT cuentas_por_pagar_pedido_id_fkey FOREIGN KEY (pedido_id) REFERENCES public.pedidos(id);
...
\unrestrict mE0wvJDr7wAWcVXMgS6LCnhVbjMwdbJSRRYYbCGAZoHV18p8yXfYiExbUCYavAj
