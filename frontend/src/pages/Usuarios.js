...
const Usuarios = () => {
  ...
  const roles = [
    { id: 1, nombre: 'Administrador', color: 'error' },
    { id: 2, nombre: 'Gerente', color: 'warning' },
    { id: 3, nombre: 'Vendedor', color: 'info' },
  ];
  ...
  const getRolInfo = (rol_id) => {
    return roles.find(r => r.id === rol_id) || { nombre: 'Desconocido', color: 'default' };
  };
